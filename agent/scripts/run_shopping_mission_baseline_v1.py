"""Run or score Shopping Mission baseline comparison V1."""
...
async def _run(args: argparse.Namespace) -> dict[str, object]:
    ...
    from agent.evaluation.shopping_mission_baseline_runner_v1 import ModelCall, run_profile
...
def main() -> int:
    ...
    if args.command == "run":
        ...
        from agent.evaluation.shopping_mission_baseline_scorer_v1 import score_run, write_score_new
