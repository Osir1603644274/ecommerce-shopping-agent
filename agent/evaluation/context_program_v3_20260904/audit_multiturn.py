...
def audit(attempt):
    ...
    registered={file_sha(HERE.parent/'context_program_v1_20260904/p1/conversations.jsonl'):'raw_utf8',
        file_sha(HERE/'p1/breadth001/dev.jsonl'):'canonical_json_string',
        file_sha(HERE/'p1/breadth001/confirm.jsonl'):'canonical_json_string'}
