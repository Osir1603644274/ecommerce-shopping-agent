"""Audit or run the frozen used-phone semantic contract benchmark v2."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    from agent.evaluation.used_phone_contract_benchmark_runner_v2 import (
    ...
    if args.allow_sealed_test and set(args.split or ()) != {"test"}:
        raise PublicRunnerError("--allow-sealed-test requires an explicit test-only selection")
