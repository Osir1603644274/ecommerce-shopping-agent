"""Versioned live scorer for V4 on the repaired common fixed_v1 baseline."""
...
ASSET_ROOT = EVALUATION_ROOT / "assets" / "shopping_task_state_context_ab_v4_20260827"
TREATMENT_SERVER = EVALUATION_ROOT / "shopping_task_state_context_ab_v4_server.py"
...
async def score_live_pair(**kwargs: Any) -> dict[str, Any]:
    ...
    report = result["score"]
    report.update({
        "schemaVersion": "shopping-task-state-context-live-score-v4",
    ...
    manifest.update({
        "schemaVersion": "shopping-task-state-context-live-manifest-v4",
