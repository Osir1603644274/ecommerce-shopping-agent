...
for index in range(1,13):
    ...
    if index==11:
        ...
        local['noAdditionalEffect']=len(row['ledger'])==(1 if index in (9,10) else 0)
...
json_new(out/'verification.json',verified);print({k:v for k,v in verified.items() if k not in ('sourceHashes','cases')})
