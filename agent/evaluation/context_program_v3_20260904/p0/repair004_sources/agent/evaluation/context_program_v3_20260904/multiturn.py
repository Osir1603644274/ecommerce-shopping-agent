...
def main(args):
    p2 = json.loads((HERE / 'p2/attempt003/result.json').read_text(encoding='utf-8'))
    ...
    json_new(out / 'protocol.json', {'at': now(), 'pid': os.getpid(), 'dataset': str(args.dataset),
        ...
        'syntheticPriceCatalog': 'data/derived/ecommerce/used_phone_catalog_expansion_kuaisearch_09807c_20260823_r3',
        'maxExtractionCallsIncludingFormatRetry': 2,
