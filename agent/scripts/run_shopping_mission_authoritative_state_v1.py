"""Run or score the authoritative MissionState compiler profile."""
...
def main() -> int:
    ...
    if args.command == "run":
        ...
        from agent.evaluation.shopping_mission_authoritative_state_scorer_v1 import score_run, write_score_new
