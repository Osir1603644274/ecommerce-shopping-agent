...
def test_multiturn_binds_histories_identities_and_no_obsolete_client(tmp_path, monkeypatch):
    import openai
    from agent.app import llm, task_state
    ...
    for name in ('multi_agent_v2_enabled', 'memory_projection_client_enabled', 'task_state_extraction_strict_enabled', 'deepseek_base_url'):
