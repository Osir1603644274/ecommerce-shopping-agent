"""Evaluation-only V4 treatment server on the repaired common fixed_v1 baseline."""
...
@app.get("/internal/evaluation/taskstate-context-ab-v4")
async def treatment_status_v4(
